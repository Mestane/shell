...
JsonObject {
    ...
    component WebSearch: JsonObject {
        ...
        property list<var> engines: [
            ...
            { name: "YouTube", url: "https://www.youtube.com/results?search_query=%1", searxEngine: "youtube", type: "video" },
            { name: "Images", url: "https://www.google.com/search?tbm=isch&q=%1",  searxEngine: "", type: "images" },
            { name: "GitHub", url: "https://github.com/search?q=%1", searxEngine: "github", type: "web" },
        ]
    }
}
